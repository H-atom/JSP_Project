...
<head>
    ...
    <script type="text/javascript">
        ...
        window.onload=function() {
            ...
            var divStud=document.getElementById("divStud");//查看花名册界面
            // 左侧功能表的翻转实现
...
<div style="display: flex">
    ...
    <div style="display: block;background-color: rgba(10,10,10,0.2);margin-top:0;position: absolute;top: 200px;left: 600px;z-index: 2" id="divSure">
        <div style="background-color: white;height: 207px;width: 306px;margin-top: 60px">
            <p style="color: #00ccff;margin: 0;padding: 0;line-height: 160px;height: 0">${addSuccess}${noneTable}${terror}</p>
            <button style="text-align: center;margin-top: 32px;margin-right: -212px;color:white;background-color: #00ccff;width: 60px;height: 33px" onclick="exit()">确定</button>
        </div>
    </div>
    <!--    添加课程界面的实现-->
    <div style="display: block" id="divAdd">
    ...
    <%--  弹窗的实现--%>
    <div style="display: none;background-color: rgba(10,10,10,0.2);margin-top:0;position: absolute;top: 200px;left: 600px;z-index: 2" id="divsSure">
        <div style="background-color: white;height: 207px;width: 306px;margin-top: 60px">
            ...
            <button style="text-align: center;margin-top: -33px;margin-left: 230px;color:white;background-color: #00ccff;width: 60px;height: 33px;display: block" onclick="exits()">取消</button>
        </div>
    </div>
    <script>
        var flags=true;
        function exits() {
            var div=document.getElementById("divsSure");
            if (flags){
    ...
    <!--    录入课表界面的实现-->
    <div id="divChoose" style="display: none">
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="width: 200px">
                                    <button onclick="exits()" style="color: white;background-color: #ec6941;display: none;height: 37px;width: 100px;margin-left: -60px" id="buttonAdd">选课结束设置</button>
...
<%--                            <td><input type="text" placeholder="课序号" value="${courseNumber}"></td>--%>
...
<%--                            <td><input type="text" placeholder="绩点" value="${gpa}"></td>--%>
                            ...
                            <td><button type="submit" formmethod="post" onclick="post(this)" style="width: 80px;background-color: coral;color: #f3f5f8"><h3 style="margin: 0;padding: 0">提交</h3></button></td>
                        </tr>
