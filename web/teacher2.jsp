...
<head>
    ...
    <script type="text/javascript">
        ...
        window.onload=function() {
            ...
            var divAdd=document.getElementById("divAdd")//添加界面
    ...
    <div style="display: none" id="divAdd">
        <ul style="width: 1200px;margin-left: 40px;padding: 0;background-color: #f3f5f8;height: 600px">
            ...
            <form style="margin: 0;padding: 0" id="form">
                ...
                <script>//录入课表各功能的函数
                <%
                if (request.getAttribute("addSuccess")!=null||request.getAttribute("noneTable")!=null||request.getAttribute("terror")!=null){%>
                window.onload=function () {//判断页面状态函数
                    var divSure=document.getElementById("divSure");
                ...
                %>
                window.onload=function () {//反馈给areatext的内容
...
<%--                            <td><input type="text" placeholder="绩点" value="${gpa}"></td>--%>
    ...
    <%--    查找成绩界面--%>
    <div id="divLook" style="display: block ">
            ...
            <li style="margin:0;height: 70px;background-color: #f3f5f8;width: 100%">
                <table style="height: 70px;line-height: 70px;margin: 0;padding: 0;width: 100%">
                    <form>
                        ...
                        <tr><td colspan="2"><span style="color: red;font-family: 华文行楷,serif; font-size: medium">${terrors}${nothing}</span></td></tr>
                    </form>
                </table>
            </li>
                ...
                <table border="1" class="chooseTable">
                    ...
                    <table class="bottomTable" border="=1">
                        <%
                            ...
                            ArrayList<User> arrayList3=new inquireData().inquire(term,number,name,type,student);
