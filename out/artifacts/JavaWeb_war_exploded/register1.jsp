...
<div style="position: relative;z-index: 1">
    <table id="table">
        ...
        <tr id="tr1">
            <td colspan="2"><button id="butt" onclick="sure()" type="submit"  formmethod="post"><h4 style="margin: 0;padding: 0;font-family: 华文宋体,serif ">立即注册</h4></button></td>
        </tr>
    ...
    <div style="background-color: rgba(10,10,10,0.2);margin-top:0;position: absolute;top: 0;left: 0;z-index: 2" id="div">
        <div style="background-color: white;height: 80px;width: 175px">
            <p style="color: #00ccff">${success}</p>
            <form style="text-align: right;margin-top: 32px;margin-right: -26px" target="_self">
                <input type="hidden" name="input" value=<%=request.getAttribute("sex")%>>
